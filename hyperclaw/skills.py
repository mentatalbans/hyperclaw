    ...
    CORE_SKILLS = [
        {
            ...
            "agents": ["assistant", "comms_agent", "briefing_agent"],
            "status": "active",
            "safety_score": 1.0,
            "source": "core",
        },
        {
            ...
            "agents": ["assistant", "comms_agent", "seldon_sales"],
            "status": "active",
            "safety_score": 0.9,
            "source": "core",
        },
        {
            ...
            "agents": ["assistant", "solomon", "telegram_agent"],
            "status": "active",
            "safety_score": 1.0,
            "source": "core",
        },
        ...
        },
        {
            ...
            "agents": ["assistant", "personal_assistant"],
            "status": "active",
            "safety_score": 1.0,
            "source": "core",
        },
        ...
        },
        {
            ...
            "agents": ["assistant", "code_specialist", "infra_agent", "security_agent"],
            "status": "active",
            "safety_score": 0.85,
            "source": "core",
        },
        ...
        },
        {
            ...
            "agents": ["assistant", "db_agent", "memory_agent", "ledger"],
            "status": "active",
            "safety_score": 0.95,
            "source": "core",
        },
        {
            ...
            "category": "memory",
            "tags": ["memory", "memory_store", "store", "persist"],
            "agents": ["*"],
            "status": "active",
            "safety_score": 1.0,
            "source": "core",
        },
        {
            ...
            "agents": ["assistant", "intel_agent", "nexus_strategy", "core_reasoner"],
            "status": "active",
            "safety_score": 0.9,
            "source": "core",
        },
        ...
        },
        {
            ...
            "description": "Monitor ATLAS_TRADING trading positions and P&L on Hyperliquid",
            "category": "trading",
            "tags": ["trading", "trading", "hyperliquid", "pnl"],
            "agents": ["trading_agent", "assistant"],
            "status": "active",
            "safety_score": 0.9,
            "source": "core",
        },
        ...
        },
        {
            ...
            "agents": ["code_specialist", "infra_agent", "assistant"],
            "status": "active",
            "safety_score": 0.9,
            "source": "core",
        },
        ...
        },
        {
            ...
            "agents": ["crypto_agent", "trading_agent"],
            "status": "active",
            "safety_score": 0.85,
            "source": "core",
        },
